...
import { RotateCw, Search, ChevronDown, ChevronUp, Loader2, Divide } from "lucide-react";
...
export default function PdfRenderer({ url }: PdfRendererProps) {
    ...
    return (
        <div className="w-full bg-white rounded-md shadow flex flex-col items-center">
            <div className="h-14 w-full border-zinc-200 border-b flex items-center justify-between px-4">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button className="gap-1.5" aria-label="zoom" variant="ghost">
                                ...
                                {scale * 100}%<ChevronDown className="h-3 w-3" />
                            </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent>
