                ...
                <div {...getRootProps()} className="border h-64 m-4 border-dashed border-gray-300 rounded-lg">
                    <div className="flex items-center justify-center h-full w-full">
                        <label
                            ...
                            className="flex flex-col items-center justify-center w-full h-full rounded-lg curser-pointer bg-gray-50 hover:bg-gray-100">
...
export default function UploadButton() {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(v: any) => {
            if (!v) {
                setIsOpen(v)
            }
        }}>
