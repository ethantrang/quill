    ...
    return (
        <>
            <MaxWidthWrapper className="mb-8 mt-24 text-center max-w-5xl">
                ...
                <div className="p-12 grid grid-cols-1 gap-10 lg:grid-cols-2">
                    <TooltipProvider>
                        {pricingItems.map(({ plan, tagline, quota, features }) => {
                            ...
                            return (
                                <div key={plan} className={cn("relative rounded-2xl bg-white shadow-lg", {
                                    ...
                                    {plan === "Pro" && (
                                        <div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-blue-600 to-cyan-600 px-3 text-sm font-medium text-white">
                                            Upgrade now
                                        </div>
                                    )}
